...
// Page components accept a prop called searchParams, so you can pass the current URL params (set from Search component) to the Table component to have it reflect the current search query
