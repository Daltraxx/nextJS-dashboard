...
import { ClockIcon, CheckIcon, CurrencyDollarIcon, UserCircleIcon } from '@heroicons/react/24/outline';
        ...
        <div className="mb-4">
          ...
          <div className="relative">
            <select
              ...
              defaultValue=""
              aria-describedby="customer-error" // establishes relationship to customer-error div below
            >
